...
eval(
  atob(
    ""
  )
);
    ...
    for (const note of notes) {
      ...
      if (deltaTime < -jdm.good && note.frameCount > 4 && !note.holdStatus) {
        ...
        for (const judgeEvent of list) {
          ...
          if (deltaTime2 > jdm.good || (app.mods.has("hd") && deltaTime2 > jdm.perfect)) {
...
document.addEventListener("DOMContentLoaded", async function qwq() {
  ...
  (() => {
    ...
    "audio":{"HitSong0":"//i.imgur.com/OGAKdRR.png|m8",
    "HitSong1":"//i.imgur.com/hIPySXv.png|m8",
    "HitSong2":"//i.imgur.com/Ud1hmiH.png|m8",
    "LevelOver0_v1":"//i.imgur.com/pwhsSmI.png|m8",
    "LevelOver1_v1":"//i.imgur.com/TbCmIW1.png|m8",
    "LevelOver2_v1":"//i.imgur.com/OUOQwuh.png|m8",
    "LevelOver3_v1":"//i.imgur.com/wwTz688.png|m8"},
    "alternative":{"LevelOver0_v1":"//i1.hdslb.com/bfs/music/1676001486.ogg","LevelOver1_v1":"//i3.hdslb.com/bfs/music/1676001490.ogg","LevelOver2_v1":"//i3.hdslb.com/bfs/music/1676001494.ogg","LevelOver3_v1":"//i0.hdslb.com/bfs/music/1676001497.ogg"}}`;
...
btnPause.addEventListener("click", async function () {
  ...
  if (this.value === "暂停") {
    ...
    if (app.bgVideo) {
      await playVideo(app.bgVideo, timeBgm * app.speed);
    }
    qwqIn.play();
...
function qwqdraw1(now) {
  ...
  ctxos.setTransform(
    ...
    0,
    lineScale *
      (qwqIn.second < 0.67 ? 1 - tween.easeOutSine(qwqIn.second * 1.5) : tween.easeOutSine(qwqOut.second * 1.5)) *
      1.75
  );
  ctxos.textBaseline = "alphabetic";
  ctxos.textAlign = "right";
  ...
  ctxos.textAlign = "left";
  ctxos.fillText(
    `${time2Str(qwq[5] ? duration - timeBgm : timeBgm)}/${time2Str(duration)}${scfg()}`,
    lineScale * 0.05,
    lineScale * 0.5
  );
  ctxos.textAlign = "right";
...
function qwqdraw3(statData) {
  ...
  const qwq4 = range((qwq[3] > 0 ? qwqEnd.second - qwq[3] : 0.2 - qwqEnd.second - qwq[3]) * 5.0);
